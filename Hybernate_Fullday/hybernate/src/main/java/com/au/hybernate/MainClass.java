package com.au.hybernate;


import java.util.List;

import com.au.hybernate.bankservice.BankService;
import com.au.hybernate.entity.Account;
import com.au.hybernate.entity.Audit;
import com.au.hybernate.entity.User;
...
public class MainClass {
	public static void main(String []args) {
		...
		///user1
		User user1 = new User();
		user1.setFirstName("neeraj");
		user1.setLastName("solanki");
		user1.setCity("bombay");
		bank.addUser(user1);

		/// user2
		User user2 = new User();
		user2.setFirstName("kuldeep");
		user2.setLastName("solanki");
